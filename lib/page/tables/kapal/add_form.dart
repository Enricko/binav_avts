...
class AddKapal extends StatefulWidget {
  const AddKapal({super.key});

  @override
  State<AddKapal> createState() => _AddKapalState();
}

class _AddKapalState extends State<AddKapal> {
                        ...
                        child: Column(
                          children: [
                            ...
                            CustomTextField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty || value == "") {
                                  return "The Bendera field is required.";
                                }
                                return null;
                              },
                            ),
                            CustomTextField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty || value == "") {
                                  return "The Kelas field is required.";
                                }
                                return null;
                              },
                            ),
                            ...
                            CustomTextField(
                              ...
                              validator: (value) {
                                if (value == null || value.isEmpty || value == "") {
                                  return "The Tahun Pembuatan field is required.";
                                }
                                return null;
                              },
                            ),
